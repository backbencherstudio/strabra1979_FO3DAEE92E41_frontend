...
export default function InputAndChecklistSetupForm() {
  ...
  return (
    <form>
      <FieldGroup className="grid grid-cols-1 gap-3 @3xl:grid-cols-2 @3xl:gap-4">
        ...
        <Button variant="muted" type="button" className="col-span-full h-23 flex-col">
        ...
        <Button variant="muted" type="button" className="h-auto flex-col">
          <PlusSignSquare className="size-6" />
